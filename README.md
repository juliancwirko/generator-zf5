...
**This project is not maintained anymore. There is Foundation for Sites 6** go and check it: [foundation.zurb.com](http://foundation.zurb.com/)
...
Also check out [Getting Started with Foundation 6’s CLI Tools](https://www.sitepoint.com/getting-started-with-foundation-6s-cli-tools/). Thanks!
